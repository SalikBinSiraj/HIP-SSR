          ...
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_landing_pg/Farukhnagar_map/thumb/Block_A.png")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_landing_pg/Farukhnagar_map/thumb/Block_C.png")}
                ></img>
        ...
        <div className="ep_sld eps1">
          <div className="ep_sld_one">
            ...
            <div className="mob_map_img_dv">
              <div className="ep_map_dv">
                <img
                  src={require("../../../../assets/img/elsc_landing_pg/Farukhnagar_map/thumb/Block_D.png")}
                ></img>
      ...
      <a className="prk_img_popup_close">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require('../../../../assets/img/elsc_landing_pg/Farukhnagar_map/popup_img/Block_C.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      <a className="prk_img_popup_close">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require('../../../../assets/img/elsc_landing_pg/Farukhnagar_map/popup_img/Block_D.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      <a className="prk_img_popup_close">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require('../../../../assets/img/elsc_landing_pg/Farukhnagar_map/popup_img/Block_E.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
      ...
      <div className="prk_img_popup" id="div_mob5">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require('../../../../assets/img/elsc_landing_pg/Farukhnagar_map/popup_img/Block_J1.jpg')}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
