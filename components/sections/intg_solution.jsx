...
import arrowSafari from '../../assets/img/integrate_arrow_safari.png';
import arrow from '../../assets/img/integrate_arrow.png';
import integrateSolution from '../../assets/img/integrate_solution.webp';
import delligence from '../../assets/img/licensing-due-diligence.webp';
import landAcquisition from '../../assets/img/land-acquisition.webp';
import parkConstruction from '../../assets/img/park-construction.webp';
                ...
                <div className='row no_LR_margin iteg_row'>
                    ...
                    <div className='col-lg-6 col-md-12 col-12 ing_solu_col_2'>
                        ...
                        <div className='intg_sol_img assts_dev_img'>
                            ...
                            <img className='' src={landAcquisition} ></img>
                        </div>
                        <div className='intg_sol_img land_acq_img'>
                            <div className='intq_img_overlay'></div>
                            <img className='' src={parkConstruction} ></img>
                        </div>
                        <div className='intg_sol_img licen_dd_img'>
                            <div className='intq_img_overlay'></div>
                            <img className='' src={delligence} ></img>
                        </div>
                        <div className='intg_sol_img facility_manag_img'>
                            <div className='intq_img_overlay'></div>
                            <img className='' src={integrateSolution} ></img>
                        </div>

                        <img className='intg_arrow chrome_integ_img' src={arrow} />
                        <img className='intg_arrow safari_integ_img' src={arrowSafari} />
