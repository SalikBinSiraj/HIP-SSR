...
import panIndia from '../../assets/img/Pan_India_Presence.jpg'
import safety from '../../assets/img/Safety_and_security.jpg'
import sustainability from '../../assets/img/Sustainability.jpg'
import compliance from '../../assets/img/compliance.jpg'
import efficiency from '../../assets/img/Efficiency.jpg'
import scalability from '../../assets/img/Scalability.jpg'
        ...
        <div className='cstm_container'>
          <div className='row'>
            ...
            <div className='row img-grid'>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="park-env-img" src={panIndia}></img>
                    <div className='img-content'>
                      <h2>Pan India presence</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="park-env-img" src={scalability}></img>
                    <div className='img-content'>
                      <h2>Scalability</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="park-env-img" src={efficiency}></img>
                    <div className='img-content'>
                      <h2>Efficiency</h2><img className="toggl-icon" src={closeIcon}></img>
            ...
            {/* <div className='row img-grid no-padding'> */}
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    <img className="park-env-img" src={compliance}></img>
                    <div className='img-content'>
                      <h2>Fully compliant</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    <img className="park-env-img" src={sustainability}></img>
                    <div className='img-content'>
                      <h2>Sustainability</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="park-env-img" src={safety}></img>
                    <div className='img-content'>
                      <h2>Safety and security</h2><img className="toggl-icon" src={closeIcon}></img>
