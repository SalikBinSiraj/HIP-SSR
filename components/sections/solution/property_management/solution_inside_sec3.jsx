...
import greenlandscape from '../../../../assets/img/solutions_inside/proprty_mang/green_landscape.jpg'
import twentryfour from '../../../../assets/img/solutions_inside/proprty_mang/proprty_mang_24x7.jpg'
import emergency from '../../../../assets/img/solutions_inside/proprty_mang/proprty_mang_emergency.jpg'
import safety from '../../../../assets/img/solutions_inside/proprty_mang/proprty_mang_safety.jpg'
      ...
      <div className='sol_inside_sec3 mob_pd_LR tab_pd_LR prop_mang_sec3 solution_desktop_sec'>
        <div className='cstm_container'>
            ...
            <div className='row sip_img_cnt_row1 sol_dv_orange'>
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Safety and security' src={safety}></img>
                    </div>
                </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Emergency preparedness' src={emergency}></img>
                    </div>
                </div>
            </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_orange'>
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='24*7 uninterrupted operations' src={twentryfour}></img>
                    </div>
                </div>
                <div className='col-lg-8 col-md-12 col-12 sip_cntn_col'>
                    <div className='sip_cntn_dv'>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-12 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Green Landscape' src={greenlandscape}></img>
                    </div>
                </div>
            </div>
        </div>
