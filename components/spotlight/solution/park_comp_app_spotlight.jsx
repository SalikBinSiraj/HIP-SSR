...
import spotlight from '../../../assets/img/solutions_inside/parks_compliance/park_complnce_spotlight_new.webp';
  ...
  return (
    <>
        <div className='park_inside_spotlight_sec'>
            ...
            <img src={spotlight} alt='Grade a industrial and logistics park park compliances and approvals' className='park_inside_bg_img'></img>
