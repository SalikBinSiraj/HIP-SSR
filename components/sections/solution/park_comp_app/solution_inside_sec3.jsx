...
import spotlight from '../../../../assets/img/solutions_inside/parks_compliance/park_complnce_spotlight.jpg'
import contract from '../../../../assets/img/solutions_inside/parks_compliance/park_complnce_contract.jpg'
import diligence from '../../../../assets/img/solutions_inside/parks_compliance/park_complnce_diligence.jpg'
      ...
      <div className='sol_inside_sec3 mob_pd_LR tab_pd_LR solution_desktop_sec'>
        <div className='cstm_container'>
            ...
            <div className='row sip_img_cnt_row1 sol_dv_orange'>
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Industrial park compliance with regulations' src={spotlight}></img>
                    </div>
                </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Industrial park contract & lease management' src={contract}></img>
                    </div>
                </div>
            </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_orange'>
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Industrial park due diligence' src={diligence}></img>
                    </div>
                </div>
                <div className='col-lg-8 col-md-8 col-12 sip_cntn_col'>
                    <div className='sip_cntn_dv'>
