...
import ready from '../../../../assets/img/solutions_inside/park_const/park_const_readymove.jpg'
import bts from '../../../../assets/img/solutions_inside/park_const/park_const_bts.jpg'
      ...
      <div className='sol_inside_sec3 mob_pd_LR tab_pd_LR solution_desktop_sec'>
        <div className='cstm_container'>
            ...
            <div className='row sip_img_cnt_row1 sol_dv_orange'>
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Built-to-suit horizon industrial parks' src={bts}></img>
                    </div>
                </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Ready-to-move industrial park' src={ready}></img>
                    </div>
                </div>
            </div>
