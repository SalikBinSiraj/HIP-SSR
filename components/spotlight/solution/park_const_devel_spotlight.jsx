...
import parkConstruction from '../../../assets/img/solutions_inside/park_const/park_const_spotlight.jpg'
  ...
  return (
    <>
        <div className='park_inside_spotlight_sec'>
            ...
            <img alt='Industrial park construction' src={parkConstruction} className='park_inside_bg_img'></img>
