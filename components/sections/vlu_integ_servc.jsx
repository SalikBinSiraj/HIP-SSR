...
import FacilitiesManagement from '../../assets/img/Facilities_management.jpg'
import parkConstruction from '../../assets/img/Park_construction1.jpg'
import licensing from '../../assets/img/Licensing_due.jpg'
import landAcquisition from '../../assets/img/Land_Acquisition1.jpg'
                            ...
                            <div className='col-lg-6 col-md-6 col-12 no_padding vlu_col4'>
                                ...
                                <a href='/solutions/property-management'>
                                    <div className='vlu_intg_srvc_outer faci_outer p_opacity' ref={vlu_box4} id='vlu_box4'>
                                        <div className='vlu_intg_srvc_inner'>
                                            <img src={FacilitiesManagement}></img>
