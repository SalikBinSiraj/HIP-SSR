            ...
            <div className='ep_sld_one'>
                ...
                <div className='mob_map_img_dv'>
                    <div className='ep_map_dv'>
                        <img src={require('../../../../assets/img/elsc_landing_pg/Delhi_II_map/thumb/Delhi_II_Block_A.png')}></img>
        ...
        <a className="prk_img_popup_close">
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    ...
                    src={require("../../../../assets/img/elsc_landing_pg/Delhi_II_map/popup_img/Block_A.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
