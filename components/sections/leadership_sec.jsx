...
import Aviraj from '../../assets/img/explore/Aviraj_nandan.jpg'
import KunalShah from '../../assets/img/explore/Kunal_shah.jpg'
import PoojaMalik from '../../assets/img/explore/Pooja_malik.jpg'
import Mahendra from '../../assets/img/explore/Mahendra_waghule.jpg'
import RkNarayan from '../../assets/img/explore/RK_narayan.jpg'
import Taruna from '../../assets/img/explore/Taruna_mahajan.jpg'
import Swati from '../../assets/img/explore/Swati_karmarkar.jpg'
import Mitesh from '../../assets/img/explore/Mitesh_Garg.jpg'
import Janmejay from '../../assets/img/explore/janmejay.jpg'
import closeIcon from '../../assets/img/svg/close_icon.svg'

import linkedin from '../../assets/img/svg/linkedin_icon.svg'
import RkNarayanProfile from '../../assets/img/explore/rk_narayan_profile.jpg'
import MahendraProfile from '../../assets/img/explore/mahendra_waghule_profile.jpg'
import PoojaMalikProfile from '../../assets/img/explore/pooja_malik_profile.jpg'
import KunalShahProfile from '../../assets/img/explore/kunal_shah_profile.jpg'
import AvirajProfile from '../../assets/img/explore/aviraj_nandan_profile.jpg'
import TarunaProfile from '../../assets/img/explore/taruna_mahajan_profile.jpg'
import SwatiProfile from '../../assets/img/explore/swati_karmarkar_profile.jpg'
import MateshProfile from '../../assets/img/explore/mitesh_garg_profile.jpg'
import JanmejayProfile from '../../assets/img/explore/janmejay_profile.jpg'
...
export default function Leadership_sec() {
  ...
  useEffect(() => {
    ...
    $('.janmejay').on("click", function () {
      $('.team_slidebox').css('transform', 'translateX(0%)');
      $('.janmejay_cont').fadeIn();
      $('.leader_overlay').fadeIn();
      $('body').css('overflow', 'hidden');
...
{/*
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card'>
              <div className='card tm_card narayn'>
                <img className='leader_img' src={RkNarayan} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card'>
              <div className='card tm_card mahendra'>
                <img className='leader_img' src={Mahendra} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card'>
              <div className='card tm_card pooja'>
                <img className='leader_img' src={PoojaMalik} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card'>
              <div className='card tm_card kunal'>
                <img className='leader_img' src={KunalShah} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card lead_card_2'>
              <div className='card tm_card aviraj'>
                <img className='leader_img' src={Aviraj} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card lead_card_2'>
              <div className='card tm_card taruna'>
                <img className='leader_img' src={Taruna} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card lead_card_2'>
              <div className='card tm_card swati'>
                <img className='leader_img' src={Swati} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card lead_card_2'>
              <div className='card tm_card mitesh'>
                <img className='leader_img' src={Mitesh} ></img>
                <div className='card-body tm_body'>
            ...
            <div className='col-lg-3 col-md-3 col-12 lead_card lead_card_2'>
              <div className='card tm_card janmejay'>
                <img className='leader_img' src={Janmejay} ></img>
                <div className='card-body tm_body'>
                  <h4 className='card-title tm_content janme_cont'>Lt. Col. Janmejay Srivastav</h4>
                  <p className='card-text tm_content_1'>Head of Operations</p>
                </div>
              </div>
            </div>
        ...
        <div className='team_slidebox'>
          <img className='close_tm_box' src={closeIcon}></img>
          ...
          <div className='row'>
            <div className='col-12'>
              ...
              {/* Lt. Col. Janmejay Srivastav */}
              <div className='janmejay_cont tm_cont_box'>

                <div className='row'>
                  <div className='col-lg-8 col-md-12 col-12 tm_fullcontent_col'>

                    <h4 className='tm_name_LB'>Lt. Col. Janmejay Srivastav </h4>
                    <h5 className='tm_designation_LB'>Head of Operations</h5>

                    <div className='tm_p_dv'>
                      <p className='para'>Janmejay served with the Indian Army from 1996 till 2018. In his illustrious career spanning 27 years, he has worked with Coldex Logistics as their Head of Operations and served as the CEO of UnoHq Technologies, an office development business. Janmejay has also led as CEO of two warehousing-focused entities - Pragati Infra Solutions and LAS Ventures. </p>

                      <p className='para'>Janmejay holds a BSc in Mathematics from the University of Madras, and an Executive MBA in Operations & Finance from NMIMS, Mumbai. In addition to being a Lean Six Sigma Black Belt, he is also certified in Project Management and Supply Chain Management from IIM Ahmedabad and Infrastructure Development from IIM Bangalore.</p>


                    </div>
                    <a className='linkedin_box' href='https://in.linkedin.com/in/janmejay-srivastav' target='_blank'>
                      <img src={linkedin} ></img>
                    </a>
