...
//---------------------------------------------------------------------------------------- Book Visit Form code END
    ...
    useEffect(() => {
        $(document).ready(function () {
            ...
            // park_inside_page
            if (url === '/goa' || url === '/Goa' || url === '/GOA') {
                window.location.href = "/industrial-and-warehousing-park-verna";
            }
            if (url === '/Delhi' || url === '/delhi' || url === '/DELHI' ) {
                window.location.href = "/warehousing-park-farukhnagar";
            }
            ...
            if (url === '/client-stories') {
                let pg_name = 'Client stories page';
                $('#enquiry_page_name').val(pg_name);
                $('#site_visit_page_name').val(pg_name);
            }
    ...
    return (
        <>
            ...
            <div className='enquire_from_div'>
                <img className='enq_close_btn' src={closeIconWht}></img>
