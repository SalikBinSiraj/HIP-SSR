...
import compliances from '../../assets/img/Compliances_reporting.jpg'
import statutory from '../../assets/img/Statutory_requirements.jpg'
import dataManagement from '../../assets/img/Data_management.jpg'
import integrateArrow from '../../assets/img/integrate_arrow.png'
 ...
 <div className='gvrnce_sec snap_sec esg_gv_sec ' id='governance'>
    ...
    <div className='row no_LR_margin iteg_row'>
        ...
        <div className='col-lg-6 col-md-12 col-12 ing_solu_col_2 p_opacity ' ref={governc_para} id='governc_para'>
            <img className='intg_sol_img assts_dev_img' src={compliances} ></img>
            <img className='intg_sol_img land_acq_img' src={statutory} ></img>
            <img className='intg_sol_img licen_dd_img' src={dataManagement} ></img>


            <img className='intg_arrow' src={integrateArrow} />
        </div>
