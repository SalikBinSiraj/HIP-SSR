        ...
        <div className="cstm_container">
          ...
          <div className="row no_LR_margin">
              ...
              <div className="col-12">
                <h2 className="section_heading txt_wht ">AVAILABLE spaces</h2>
              </div>
              <div className="col-12">
                  {/*------------------------------------------------------------------------------------------------------------------- TAB 1 */}
                  {/* TAB 1 Links */}
                              ...
                              <div className="col-lg-2 col-md-12 col-12">
                                ...
                                <div className="elsc_sec_tab2_links_div">
                                  <ul className="nav nav-pills elsc_sec2_tab2" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link active elsc_tab2_link" data-bs-toggle="pill" href="#farukhnagar">Farukhnagar {'(5)'}</a>
                                    </li>
                                    <li className="nav-item">
                                    ...
                                    <li className="nav-item">
                                        <a className="nav-link elsc_tab2_link" data-bs-toggle="pill" href="#bilaspur">Bilaspur II {'(2)'}</a>
                                    </li>
                                  </ul>
                                </div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-2 col-md-2 col-12">
                              ...
                              <div className="elsc_sec_tab2_links_div">
                                <ul className="nav nav-pills elsc_sec2_tab2" role="tablist">
                                  <li className="nav-item">
                                      <a className="nav-link active elsc_tab2_link" data-bs-toggle="pill" href="#kothur">Kothur {'(6)'}</a>
                                  </li>
                                  <li className="nav-item">
                            ...
                            <div className="row">
                              ...
                              <div className="col-lg-2 col-md-12 col-12">
                                ...
                                <div className="elsc_sec_tab2_links_div">
                                  <ul className="nav nav-pills elsc_sec2_tab2" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link active elsc_tab2_link" data-bs-toggle="pill" href="#shoolagiri">Hosur I {'(3)'}</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className="nav-link elsc_tab2_link" data-bs-toggle="pill" href="#dobaspet">Dobbaspet I {'(9)'}</a>
                                    </li>
                                  </ul>
                                </div>
                          ...
                          <div className="row">
                              ...
                              <div className="col-lg-2 col-md-2 col-12">
                                ...
                                <div className="elsc_sec_tab2_links_div">
                                  <ul className="nav nav-pills elsc_sec2_tab2" role="tablist">
                                    <li className="nav-item">
                                        <a className="nav-link active elsc_tab2_link" data-bs-toggle="pill" href="#chakan_5">Chakan V {'(5)'}</a>
                                    </li>
                                  </ul>
                                </div>
