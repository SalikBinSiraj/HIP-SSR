...
import valueAsset from '../../assets/img/value-asset.webp';
                ...
                <div className='cstm_container'>
                    ...
                    <div className='row assts_hd_row'>
                        <div className='col-12'>
                            <p className='section_sub_heading value_assets_sub_hd p_opacity' ref={vlue_hd_fade} id='vlue_hd_fade'>Total portfolio</p>
                            <hr className='add_border p_opacity' ref={vluBorder_aniamtion} id='vluBorder_aniamtion'/>
                        </div>
                    </div>
                    <div className='row'>
                        <div className='col-12'>
                            <div className="animate_big_txt ">
                                <h2  className='big_heading milion_hd' id='txt_animate_2' ref={txt_animate_2}>1000+ Acres </h2>
                            </div>
                    ...
                    <div className='row assts_cnt_row'>
                        <div className='col-lg-4 col-md-4 col-12 asst_col1'>
                            ...
                            <div className='vlu_assets_inner_box1'>
                                <p className='assets_subpoints p_opacity' ref={p_vlu_ani_1} id='p_vlu_ani_1'>development potential</p>
                                <hr className='add_border p_opacity' ref={vluBorder_aniamtion} id='vluBorder_aniamtion'/>
                                {/* <p className='assets_subpoints_sub_heading'>25+ Million sft</p>  */}
                                <div className="vlu_sub_hd_animate ">
                                    <p className='assets_subpoints_sub_heading ' ref={vlu_animate_1}  id='vlu_animate_1'>25+ Million sq ft</p>
                                </div>
                            </div>
                            <div className='vlu_assets_inner_box2'>
                                <p className='assets_subpoints p_opacity' ref={p_vlu_ani_2} id='p_vlu_ani_2'>Presence</p>
                                <hr className='add_border p_opacity' ref={vluBorder_aniamtion} id='vluBorder_aniamtion'/>
                                <div className="vlu_sub_hd_animate ">
                                    <p className='assets_subpoints_sub_heading' ref={vlu_animate_2}  id='vlu_animate_2'>8 Markets</p>
                                </div>
                            </div>

                            <div className='vlu_assets_inner_box2'>
                                <p className='assets_subpoints p_opacity' ref={p_vlu_ani_2} id='p_vlu_ani_2'>Fully Managed</p>
                                <hr className='add_border p_opacity' ref={vluBorder_aniamtion} id='vluBorder_aniamtion'/>
                                <div className="vlu_sub_hd_animate ">
                                    <p className='assets_subpoints_sub_heading' ref={vlu_animate_2}  id='vlu_animate_2'>17 parks</p>
                                </div>
                            </div>
                        ...
                        <div className='col-lg-8 col-md-8 col-12 asst_col2'>
                            <img className='ast_img p_opacity' src={valueAsset} ref={vlue_hd_fade} id='vlue_hd_fade'></img>
                        </div>
