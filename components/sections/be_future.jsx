...
import beFuture1 from '../../assets/img/be_future_img_1.jpg'
import beFuture2 from '../../assets/img/be_future_img_2.jpg'
import beFuture3 from '../../assets/img/be_future_img_3.jpg'
import beFuture4 from '../../assets/img/be_future_img_4.jpg'
import beFuture5 from '../../assets/img/be_future_img_5.jpg'
    ...
    return (
        <>
                ...
                <div className='row no_LR_margin'>
                    ...
                    <div className='col-lg-6 col-md-12 col-12 ing_solu_col_2 convert_form_col2 p_opacity' ref={be_fut_para} id="be_fut_para">
                        ...
                        <SliderComponent {...be_future_slider} className='be_future_slider'>
                            ...
                            <div className='be_fut_sld'>
                                <img className=' ' src={beFuture2} ></img>
                            </div>
                            <div className='be_fut_sld'>
                                <img className=' ' src={beFuture3} ></img>
                            </div>
                            <div className='be_fut_sld'>
                                <img className=' ' src={beFuture4} ></img>
                            </div>
                            <div className='be_fut_sld'>
            ...
            <div className='career_popup_box'>
                <img className='career_cls_btn' src={closeIconWht}></img>
