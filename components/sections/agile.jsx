...
import HorizontalManifesto from '../../assets/video/Horizon_Industrial_Parks_Brand_Manifesto1.mp4';
import GlobalExperience from '../../assets/video/global_experience.mp4';
import $ from "jquery";
                    ...
                    <div className='row col_row_2'>
                        <div className='col-lg-6 col-md-6 col-12'>
                            ...
                            <div className='reveal_img'>
                                ...
                                <video id='agile_video' className='agile_img gloabl_video' controls playsInline loop muted src={HorizontalManifesto} ref={videoEl} />
                        ...
                        <div className='col-lg-6 col-md-6 col-12'>
                            ...
                            <div className='reveal_img'>
                                ...
                                <video className='agile_img gloabl_video' playsInline loop muted src={GlobalExperience} ref={videoEl1} />
