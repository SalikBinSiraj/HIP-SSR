...
import land from '../../../../assets/img/solutions_inside/Strategic_land/Strategic_land_capacity.webp'
import landgoverner from '../../../../assets/img/solutions_inside/Strategic_land/Strategic_land_governer.jpg'
import landlabour from '../../../../assets/img/solutions_inside/Strategic_land/Strategic_land_labor.jpg'
import landproximicty from '../../../../assets/img/solutions_inside/Strategic_land/Strategic_land_proximicity.jpg'
        ...
        <div className='cstm_container'>
            ...
            <div className='row solution_sec3_hd'>
                <div className='col-12'>
                    <h2 class="section_sub_heading ovrview_sub_hd" >Advantage Horizon</h2>
                </div>
            </div>
            ...
            <div className='row sip_img_cnt_row1 sol_dv_orange'>
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Proximity to key markets' src={landproximicty}></img>
                    </div>
                </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Access to skilled labour & local amenities' src={landlabour}></img>
                    </div>
                </div>
            </div>
            ...
            <div className='row sip_img_cnt_row sol_dv_orange'>
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Local community partnerships and government support' src={landgoverner}></img>
                    </div>
                </div>
                <div className='col-lg-8 col-md-8 col-12 sip_cntn_col'>
                    <div className='sip_cntn_dv'>
            ...
            <div className='row sip_img_cnt_row sol_dv_gray'>
                ...
                <div className='col-lg-4 col-md-4 col-12 sip_img_col'>
                    <div className='sip_img_dv'>
                        <img alt='Capacity to scale up' src={land}></img>
                    </div>
                </div>
            </div>
