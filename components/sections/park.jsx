...
import whitePin from '../../assets/img/white_pin.png';
import greenPin from '../../assets/img/green_pin.png'
import orangePin from '../../assets/img/orange_pin.png'
import whiteMapPin from '../../assets/img/svg/white_map_pin.svg';
import greenMapPin from '../../assets/img/svg/green_map_pin.svg';
import orangeMapPin from '../../assets/img/svg/orange_map_pin.svg';
import whiteOrangeMapPin from '../../assets/img/svg/white_orange_map_pin.svg';
import whiteGreenMapPin from '../../assets/img/svg/white_green_map_pin.svg';
                ...
                <div className='col-lg-5 col-md-6 col-sm-12 col-12  park_map_col'>
                    ...
                    <div className='map_dv'>
                        ...
                        <div className='park_active_status_dv p_opacity' ref={fade_para} id='fade_para'>
                            <div>
                                <img src={whitePin}></img>
                                <p>ACTIVE / Under Construction</p>
                            </div>
                            <div>
                                <img src={greenPin}></img>
                                <p>PLanned Acquisitions</p>
                            </div>
                            <div>
                                <img src={orangePin}></img>
                                <p>JV PARKS</p>
                            </div>
                        </div>
