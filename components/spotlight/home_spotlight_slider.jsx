...
import homeSliderArrowSafari from '../../assets/img/home_sldr_arrow_safari.png'
import hipTag from '../../assets/img/hip_tag.png';
...
export default function Home_spotlight_slider() {
  ...
  return (
    <>
        ...
        <div className='home_spotlight_slider_sec ' >
                ...
                <SliderComponent {...home_slider} className='home_slider' ref={sliderRef}>
                    ...
                    <div className='hm_sld hs_0' id='hm_sld'>
                        ...
                        <img className='sld_arrow sticky_arrow chrome_spot_img' src={homeSliderArrow}></img>
                        <img className='sld_arrow sticky_arrow safari_spot_img' src={homeSliderArrowSafari}></img>
                    ...
                    <div className='hm_sld hs_1' id='hm_sld'>
                        ...
                        <video id='spotlight_video' className='spot_video' playsInline autoPlay loop muted={isMuted} src={hipSpotlight} type="video/mp4" ref={videoEl_spotlight} />
        ...
        <img className='hip_tag_img' src={hipTag}></img>
