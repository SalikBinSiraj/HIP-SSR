                ...
                <div className='row adv_row no_LR_margin'>
                    ...
                    <div className='col-lg-6 col-md-6 col-12 info_col p_opacity'  ref={adv_hori_fade} id='adv_hori_fade'>
                        <SliderComponent {...sctr_settings} className='ad_horzion_sld' asNavFor={nav2} ref={slider => (setSlider1(slider))}>
                            ...
                            <div className='ad_hz_outer'>
                                <div className='ad_hz_inner'>
                                    <img src={require('../../assets/img/svg/pan_india.svg').default} className=''></img>
                            ...
                            <div className='ad_hz_outer'>
                                <div className='ad_hz_inner'>
                                    <img src={require('../../assets/img/svg/productivity_icon.svg').default} className=''></img>
                            ...
                            <div className='ad_hz_outer'>
                                <div className='ad_hz_inner'>
                                    ...
                                    <img src={require('../../assets/img/svg/Compliance_icon.svg').default} className=''></img>
                            ...
                            <div className='ad_hz_outer'>
                                <div className='ad_hz_inner'>
                                    ...
                                    <img src={require('../../assets/img/svg/Scalability_icon.svg').default} className=''></img>
                            ...
                            <div className='ad_hz_outer'>
                                <div className='ad_hz_inner'>
                                    <img src={require('../../assets/img/svg/security_icon.svg').default} className=''></img>
