...
import esg from '../../assets/img/esg.webp';
            ...
            <div className='cstm_container'>
                ...
                <div className='row esg_row2'>
                    <div className='col-lg-6 col-md-12 col-12 esg_col1'>
                        ...
                        <a href='/sustainability' className='arrow_btn p_opacity esg_btn' ref={esg_para} id='esg_para'>Know more about our ESG initiatives</a>
                    </div>
                    <div className='col-lg-6 col-md-12 col-12 esg_img_col'>
                        <img className='esg_img ' src={esg}></img>
