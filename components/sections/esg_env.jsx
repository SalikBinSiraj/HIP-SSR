...
import certifications from '../../assets/img/certifications.jpg'
import waste from '../../assets/img/waste_management.jpg'
import water from '../../assets/img/water_management.jpg'
import biodiversity from '../../assets/img/biodiversity.jpg'
import renewableEnergy from '../../assets/img/renewable_energy.jpg'
import energySaving from '../../assets/img/energy_saving.jpg'
 ...
 <div className='esg_env_sec tab_pd_LR' id='environment'>
        <div className='cstm_container'>
          <div className='row'>
            ...
            <div className='row img-grid p_opacity' ref={esg_para} id='esg_para'>
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    <img className="esg-env-img" src={energySaving}></img>
                    <div className='img-content'>
                      <h2>Energy saving</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                  <img className="esg-env-img" src={renewableEnergy}></img>
                    <div className='img-content'>
                      <h2>Renewable Energy</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="esg-env-img" src={biodiversity}></img>
                    <div className='img-content'>
                      <h2>Biodiversity</h2><img className="toggl-icon" src={closeIcon}></img>
            ...
            <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="esg-env-img" src={water}></img>
                    <div className='img-content'>
                      <h2>Water management</h2><img className="toggl-icon" src={closeIcon}></img>
            ...
            <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                  <div className='img-clm'>
                    <img className="esg-env-img" src={waste}></img>
                    <div className='img-content'>
                      <h2>Waste management</h2><img className="toggl-icon" src={closeIcon}></img>
              ...
              <div className='col-lg-4 col-md-6 col-12 guttr-spc'>
                <div className='img-clm'>
                    <img className="esg-env-img" src={certifications}></img>
                    <div className='img-content'>
                      <h2>Certifications</h2><img className="toggl-icon" src={closeIcon}></img>
