        ...
        <div className='prk_img_popup' id='div_mob11'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    ...
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_A.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
        ...
        <div className='prk_img_popup' id='div_mob12'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_B.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
        ...
        <div className='prk_img_popup' id='div_mob13'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_C.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
        ...
        <div className='prk_img_popup' id='div_mob14'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_D.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
        ...
        <div className='prk_img_popup' id='div_mob15'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_E.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
        ...
        <div className='prk_img_popup' id='div_mob16'>
            ...
            {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                ...
                <TransformComponent>
                    <img
                    className="elsc_park_map_img epm_img"
                    src={require("../../../../assets/img/elsc_landing_pg/Kothur_map/popup_img/Block_F.jpg")}
                    ></img>
                </TransformComponent>
                </React.Fragment>
            )}
